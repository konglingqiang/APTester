...
# Form implementation generated from reading ui file 'frmmessagebox.ui'
#
# Created: Sat Jan 31 14:43:42 2015
...
class Ui_frmMessageBox(object):
    def setupUi(self, frmMessageBox):
        frmMessageBox.setObjectName(_fromUtf8("frmMessageBox"))
        frmMessageBox.resize(303, 143)
        self.verticalLayout = QtGui.QVBoxLayout(frmMessageBox)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setMargin(0)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.widget_title = QtGui.QWidget(frmMessageBox)
        ...
        self.widget_main = QtGui.QWidget(frmMessageBox)
        ...
        self.labIcoMain.setStyleSheet(_fromUtf8("border-image: url(:/image/info.png);"))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 60, 271, 34))
        ...
        self.retranslateUi(frmMessageBox)
        QtCore.QMetaObject.connectSlotsByName(frmMessageBox)

    def retranslateUi(self, frmMessageBox):
        frmMessageBox.setWindowTitle(_translate("frmMessageBox", "提示", None))
        self.lab_Title.setText(_translate("frmMessageBox", "提示", None))
        self.btnMenu_Close.setToolTip(_translate("frmMessageBox", "关闭", None))
        self.labInfo.setText(_translate("frmMessageBox", "确定要删除吗?", None))
        self.btnOk.setText(_translate("frmMessageBox", "确定(&O)", None))
        self.btnCancel.setText(_translate("frmMessageBox", "取消(&C)", None))
